...
public class CurrencyCoversionController {
    ...
    public CurrencyConversion calculateCurrencyConversion(@PathVariable String from, @PathVariable String to, @PathVariable BigDecimal quantity) {
        ...
        ResponseEntity<CurrencyConversion> responseEntity = new RestTemplate().getForEntity("http://localhost:8000/curreny-exchange/from/{from}/to/{to}", CurrencyConversion.class, uriVariables);
